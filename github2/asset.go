// Package github2 provides core logic for GitHub release asset handling.
package github2
...
// Extract extracts ExecBinaryContent from AssetContent.
func (a AssetContent) Extract(execBinary ExecBinary) (ExecBinaryContent, error) {
	return a.extract(execBinary)
}
...
// IAssetRepository is an interface for Asset and AssetContent repository.
...
// NewAssetRepository returns a new AssetRepository or ExternalAssetRepository based on repository name.
...
// List lists GitHub release assets in a given release and returns them.
